...
public class FilterEngine {
    ...
    public FilterEngine(int oestextureid, Context context) {
         ...
         */
        fragmentShader = loadShader(GL_FRAGMENT_SHADER, CameraUtils.readShaderFromResource(mContext, R.raw.base_fragment_shader));
        vertexShader = loadShader(GL_VERTEX_SHADER, CameraUtils.readShaderFromResource(mContext, R.raw.base_vertex_shader));
